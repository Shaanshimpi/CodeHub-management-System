...
router.post('/', protect, roleBasedAccess(['super_admin', 'sales_person', 'admin']), feeController.createFee);

// @route   PUT /api/fees/:id
// @desc    Update fee record
// @access  Private/SalesPerson
router.put('/:id', protect, roleBasedAccess(['super_admin', 'sales_person', 'admin']), feeController.updateFee);

// @route   POST /api/fees/payment
// @desc    Record fee payment
// @access  Private/SalesPerson
router.post('/payment', protect, roleBasedAccess(['super_admin', 'sales_person', 'admin']), feeController.recordPayment);

// @route   GET /api/fees/pending
// @desc    Get pending fees
// @access  Private/SalesPerson
router.get('/pending', protect, roleBasedAccess(['super_admin', 'sales_person', 'admin']), feeController.getPendingFees);
